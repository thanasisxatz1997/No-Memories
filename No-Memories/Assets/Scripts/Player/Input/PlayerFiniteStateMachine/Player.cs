...
public class Player : MonoBehaviour//Monobehaviour cuz it sits on our player Object
{
    ...
    public void SetVelocityY(float velocity)
    {
        ...
        RB.velocity = workspace;//we apply the velocity
        CurrentVelocity = workspace;//update our current velocity
    }
